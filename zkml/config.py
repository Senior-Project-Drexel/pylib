class Config:
    ...
    def configure(self, addresses=None, backend=None, verifier=None, client_manager=None, **backend_options):
    ...
    def _initialize_backend(self):
        if self.backend == "local":
            ...
            raise ValueError("Unknown backend. Backend options: local, trust, freivalds")
